        ...
        <nav class="main-navigation">
            <ul class="main-navigation__list">
                <?php foreach ($data['projects'] as $project): ?>
                    <li class="main-navigation__list-item <?= ($data['currentProjectCode'] === $project['code'] ? 'main-navigation__list-item--active' : ''); ?>">
        ...
        <div class="tasks-controls">
            ...
            <label class="checkbox">
                <input id="show-complete-tasks" class="checkbox__input visually-hidden"
                       type="checkbox" <?= ($data['isShowCompletedTasks'] ? 'checked' : ''); ?> >
